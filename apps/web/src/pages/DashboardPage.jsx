...
import { Calendar, CheckSquare, ShoppingCart, FileText, Cake, Plus, AlertCircle, Bell } from 'lucide-react';

function DashboardPage() {
  const todayEvents = [
    { id: 1, title: "Emma's soccer practice", time: "4:30 PM - 6:00 PM", type: "activity", location: "Riverside Field", attendees: [{ initials: "E" }] },
    { id: 2, title: "Family dinner", time: "7:00 PM", type: "family", attendees: [{ initials: "S" }, { initials: "M" }, { initials: "E" }, { initials: "L" }] },
  ];

  const upcomingEvents = [
    { id: 3, title: "Lucas's piano lesson", time: "Tomorrow, 3:00 PM", type: "activity", location: "Music Academy", attendees: [{ initials: "L" }] },
  ...
  const expiringDocs = [
    { doc: "Lucas's passport", date: "Jun 15, 2026" },
  ];

  const birthdays = [
    { name: "Grandma Rose", date: "Apr 12" },
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Your family management dashboard with calendar, tasks, and important reminders" />
      </Helmet>
        ...
        <div className="flex-1 lg:ml-64">
          ...
          <main className="p-4 sm:p-6 lg:p-8">
            <div className="max-w-7xl mx-auto">
              <div className="mb-8">
                <h1 className="text-3xl font-bold mb-2" style={{letterSpacing: '-0.02em'}}>Good afternoon, Sarah</h1>
                <p className="text-muted-foreground">Here's what's happening with your family today</p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {/* Today's Calendar */}
                <WidgetCard title="Today's calendar" icon={Calendar} action="View all" className="lg:col-span-2">
                ...
                <WidgetCard title="Task summary" icon={CheckSquare} action="View all">
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge variant="secondary" className="bg-primary text-primary-foreground">7</Badge>
                    </div>
                  ...
                  <div className="space-y-3">
                    {expiringDocs.map((doc, index) => (
                      <div key={index} className="p-3 bg-muted rounded-lg">
                        ...
                        <p className="text-xs text-accent font-medium">Expires {doc.date}</p>
                      </div>
                    ))}
                  </div>
                </WidgetCard>
